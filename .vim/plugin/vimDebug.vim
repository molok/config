...
" key bindings
map <Leader>dS      :call DBGRstartVimDebuggerDaemon(' ')<cr>
map <Leader>s/ :DBGRstartVDD

map <Leader>ds       :call DBGRstep()<CR>
map <Leader>dn       :call DBGRnext()<CR>
map <Leader>dc       :call DBGRcont()<CR>                          " continue

map <Leader>db  :call DBGRsetBreakPoint()<CR>
map <Leader>dC  :call DBGRclearBreakPoint()<CR>
map <Leader>dCa :call DBGRclearAllBreakPoints()<CR>

map <Leader>dv/ :DBGRprintExpression 
map <Leader>dv  :DBGRprintExpression2 expand("<cWORD>")<CR>   " print value
                                                             " of WORD under
                                                             " the cursor

map <Leader>/  :DBGRcommand 

map <Leader>dr      :call DBGRrestart()<CR>
map <Leader>dq      :call DBGRquit()<CR>
